...
export function resolveDefaultCommerceModeForBusinessCategory(category = "") {
  const normalizedCategory = String(category || "").trim().toLowerCase();
  if (normalizedCategory === "food_drink") return "mimenu";
  if (normalizedCategory === "retail_sales") return "mitienda";
  return "micatalogo";
}
