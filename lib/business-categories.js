...
const BUSINESS_CATEGORY_MODULE_RECOMMENDATIONS = {
  food_drink: {
    ...
    visibleWorkspaces: ["commerce", "blocks", "design", "profile", "security", "billing", "subscription"],
    moduleLabel: "Mi menú",
  ...
  health_wellness: {
    ...
    visibleWorkspaces: ["booking", "blocks", "design", "profile", "security", "billing", "subscription"],
    moduleLabel: "Agenda",
  ...
  services: {
    ...
    visibleWorkspaces: ["blocks", "booking", "design", "profile", "security", "billing", "subscription"],
  ...
  tourism_experiences: {
    ...
    visibleWorkspaces: ["reservations", "blocks", "design", "profile", "security", "billing", "subscription"],
