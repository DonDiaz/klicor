...
export const BUSINESS_TYPE_OPTIONS_BY_CATEGORY = {
  ...
  services: [
    ...
    { value: "legal_accounting", label: "Legal o contable" },
  ],
  health_wellness: [
...
const BUSINESS_CATEGORY_TEMPLATES = {
  ...
  services: {
    ...
    linkPriority: ["booking", "whatsapp", "website", "maps", "instagram", "facebook", "linkedin", "email"],
    suggestedLabels: {
...
const BUSINESS_CATEGORY_MODULE_RECOMMENDATIONS = {
  ...
  services: {
    ...
    visibleWorkspaces: ["blocks", "booking", "design", "dorika", "profile", "security", "billing", "subscription"],
