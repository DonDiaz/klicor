...
export const SOCIAL_STYLE_OPTIONS = [
  ...
  { value: "brand-circles", label: "Circulos" },
];
...
export function normalizeAppearance(input = {}) {
  ...
  return {
    ...
    fontFamily: clampEnum(input?.fontFamily, ["modern", "friendly", "editorial", "strong"], preset.fontFamily || APPEARANCE_DEFAULTS.fontFamily),
