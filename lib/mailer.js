...
export function sendWelcomeEmail(user) {
  return deliverEmail({
    ...
    html: `<div style="font-family:Arial,sans-serif;line-height:1.6"><h1>Tu perfil ya está listo</h1><p>Hola ${user.businessName || user.email}, gracias por empezar tu prueba gratuita.</p><p>Ahora puedes completar tu página, compartir tu enlace y descargar tu QR.</p></div>`,
  });
}
