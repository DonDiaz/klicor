...
const CONTEXT_RULES = [
  {
    ...
    groupOrder: ["Calzado", "Calzado ampliado", "Accesorios de moda", "Moda", "Más usadas", "Belleza y cuidado", "Especializadas", "Colecciones retail"],
  ...
  },
  {
    ...
    groupOrder: ["Moda", "Ropa ampliada", "Calzado", "Calzado ampliado", "Accesorios de moda", "Joyería y accesorios ampliados", "Más usadas", "Belleza y cuidado", "Especializadas", "Colecciones retail"],
  ...
  },
  {
    ...
    groupOrder: ["Supermercado", "Más usadas", "Especializadas", "Hogar"],
  },
  {
    intent: "beauty",
    terms: ["beauty", "belleza", "cosmeticos", "cosmetico", "maquillaje", "cuidado personal"],
    groupOrder: ["Belleza y cuidado", "Más usadas", "Moda", "Especializadas"],
  },
  {
    intent: "tech",
    terms: ["tech", "technology", "tecnologia", "electronica", "celulares", "computadores"],
    groupOrder: ["Tecnología", "Más usadas", "Especializadas"],
  },
  {
    intent: "pharmacy",
    terms: ["pharmacy", "farmacia", "drogueria", "salud", "supplements", "suplementos"],
    groupOrder: ["Farmacia y bebé", "Belleza y cuidado", "Más usadas"],
  },
  {
    intent: "hardware",
    terms: ["hardware", "ferreteria", "herramientas", "construction", "construccion"],
    groupOrder: ["Ferretería", "Hogar", "Más usadas"],
  },
  {
    intent: "pet",
    terms: ["pet", "mascotas", "mascota", "petshop"],
    groupOrder: ["Especializadas", "Más usadas", "Supermercado"],
  },
];
