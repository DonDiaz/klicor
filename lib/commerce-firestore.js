...
const COMMERCE_IMAGE_CARD_SIZE = 768;
const COMMERCE_IMAGE_THUMB_SIZE = 384;
...
async function optimizeCommerceProductImage(uid, productId, file, imageId = buildCommerceId("img")) {
  ...
  return {
    ...
    imageCardUrl: `https://firebasestorage.googleapis.com/v0/b/${bucket.name}/o/${encodeURIComponent(cardPath)}?alt=media`,
    ...
    variants: {
      thumb: {
        ...
        contentType: "image/webp",
        path: thumbPath,
        url: `https://firebasestorage.googleapis.com/v0/b/${bucket.name}/o/${encodeURIComponent(thumbPath)}?alt=media`,
      },
      card: {
        ...
        contentType: "image/webp",
        path: cardPath,
        url: `https://firebasestorage.googleapis.com/v0/b/${bucket.name}/o/${encodeURIComponent(cardPath)}?alt=media`,
      },
      large: {
