...
import { buildCommerceCategoryNormalizedKey, resolveCommerceCategoryIcon } from "@/lib/commerce-category-icons";
...
export async function createCommerceCategory(uid, input, user = null) {
  ...
  await ref.set({
    ...
    iconSource: categoryIcon.iconSource,
...
export async function createCommerceSubcategory(uid, input, user = null) {
  ...
  await ref.set({
    ...
    iconSource: subcategoryIcon.iconSource,
