...
export function normalizeDorikaProfile(input = {}, business = {}) {
  ...
  const category = normalizeBusinessCategory(business.businessCategory || source.category);
  ...
  return {
    ...
    coverImageUrl: cleanPersistentImageUrl(source.coverImageUrl || ""),
    coverImagePath: clean(source.coverImagePath || ""),
    description: clean(source.description || ""),
    category,
    businessType: normalizeBusinessType(source.businessType || source.businessSubtype || "", category),
...
export function calculateDorikaProfileProgress(input = {}, business = {}) {
  ...
  const tasks = [
    ...
    },
    {
      id: "business_type",
      label: "Qué haces",
      complete: Boolean(profile.businessType),
      copy: "Elige una descripción más precisa para aparecer mejor en búsquedas y mapa.",
    },
    {
      id: "cover",
