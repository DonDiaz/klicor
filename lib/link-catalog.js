...
export const LINK_CATALOG = [
  { type: "whatsapp", label: "WhatsApp", placeholder: "573001234567", kind: "phone", icon: WhatsAppIcon },
  { type: "instagram", label: "Instagram", placeholder: "https://instagram.com/tu_marca", kind: "url", icon: InstagramIcon },
  { type: "facebook", label: "Facebook", placeholder: "https://facebook.com/tu_marca", kind: "url", icon: FacebookIcon },
  { type: "tiktok", label: "TikTok", placeholder: "https://tiktok.com/@tu_marca", kind: "url", icon: TikTokIcon },
  { type: "website", label: "Página web", placeholder: "https://tu-negocio.com", kind: "url", icon: Globe },
  { type: "youtube", label: "YouTube", placeholder: "https://youtube.com/@tu_canal", kind: "url", icon: YouTubeIcon },
  { type: "linkedin", label: "LinkedIn", placeholder: "https://linkedin.com/in/tu-perfil", kind: "url", icon: LinkedInIcon },
  { type: "telegram", label: "Telegram", placeholder: "https://t.me/tu_usuario", kind: "url", icon: TelegramIcon },
  { type: "x", label: "X", placeholder: "https://x.com/tu_usuario", kind: "url", icon: XIcon },
  { type: "threads", label: "Threads", placeholder: "https://threads.net/@tu_usuario", kind: "url", icon: ThreadsIcon },
  { type: "spotify", label: "Spotify", placeholder: "https://open.spotify.com/artist/...", kind: "url", icon: SpotifyIcon },
  ...
  { type: "twitch", label: "Twitch", placeholder: "https://twitch.tv/tu_canal", kind: "url", icon: TwitchIcon },
];
