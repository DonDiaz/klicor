...
const DEMO_PROFILES = [
  {
    ...
    headline: "Cortes, barba y estilo masculino con agenda fácil",
    ...
    booking: true,
    services: [
      { id: "svc-corte", name: "Corte clásico", description: "Corte con asesoría de estilo.", durationMinutes: 30, price: 18000 },
  ...
  },
  {
    ...
    businessCategory: "health_wellness",
    businessType: "nails",
    headline: "Manicure, pedicure y diseños con agenda online",
    ...
    booking: true,
    services: [
      { id: "svc-manicure", name: "Manicure semipermanente", description: "Color y cuidado de uñas.", durationMinutes: 60, price: 45000 },
      { id: "svc-pedicure", name: "Pedicure spa", description: "Cuidado completo de pies.", durationMinutes: 60, price: 50000 },
      { id: "svc-diseño", name: "Diseño sencillo", description: "Detalle decorativo por uñas.", durationMinutes: 30, price: 25000 },
    ],
    staff: [
      { id: "staff-laura", name: "Laura Pabon", roleOrSpecialty: "Manicurista" },
      { id: "staff-maria", name: "María Torres", roleOrSpecialty: "Diseños y pedicure" },
    ],
  },
  {
  ...
  },
  {
    ...
    businessName: "Glamping Brisas de Ocaña",
    businessCategory: "tourism_experiences",
    businessType: "glamping",
    headline: "Naturaleza, descanso y planes románticos cerca de Ocaña",
    ...
    lng: -73.37291,
    zone: "Vía rural",
    address: "Vía rural, Ocaña",
    placeName: "Glamping Brisas de Ocaña",
  ...
  {
    uid: "demo-link-plomería-express",
    email: "donjhonnathan+klicor.demo.plomería@gmail.com",
    username: "plomería-express-demo",
    publicLinkId: "demo-link-plomería-express",
    businessName: "Plomería Express Ocaña",
    businessCategory: "services",
    businessType: "plumbing",
    headline: "Instalaciones, reparaciones y urgencias de plomería",
    ...
    placeName: "Plomería Express Ocaña",
  ...
  },
  {
    ...
    headline: "Contabilidad, impuestos y soporte para pequeños negocios",
...
function profileLinks(business) {
  const message = `Hola, vi el Klicor de ${business.businessName} y quiero más información.`;
  return [
    {
      id: "whatsapp-main",
      type: "whatsapp",
...
async function updateExistingDemoWhatsapp(db) {
  ...
  for (const doc of docs) {
    ...
    const updatedLinks = currentLinks.map((link) => {
      ...
      const message = link.message || `Hola, vi el Klicor de ${data.businessName || "este negocio"} y quiero más información.`;
      return {
        ...link,
        value: DEMO_WHATSAPP,
        message,
    ...
    const nextLinks = hasWhatsapp
      ...
      : [{
        ...
        label: "WhatsApp",
        value: DEMO_WHATSAPP,
        message: `Hola, vi el Klicor de ${data.businessName || "este negocio"} y quiero más información.`,
        priorityTier: 1,
        url: whatsappUrl(DEMO_WHATSAPP, `Hola, vi el Klicor de ${data.businessName || "este negocio"} y quiero más información.`),
      }, ...updatedLinks];
