...
function profileLinks({ whatsapp, maps, instagram, facebook, tiktok, website }) {
  const whatsappMessage = "Hola, vi tu Klicor y quiero más información.";
  return [
    {
      id: "whatsapp-main",
      type: "whatsapp",
...
const restaurant = [
  ...
  category("Entradas", [
    ...
    item("Picada pequeña", 28000, "mixed grill", "Carnes y acompañantes para compartir."),
  ]),
  category("Bebidas", [
...
const pharmacy = [
  ...
  category("Primeros auxilios", [
    ...
    item("Guantes látex", 12500, "medical gloves", "Caja pequeña."),
  ...
  category("Bebe", [
    ...
    item("Toallitas bebé", 14500, "baby wipes", "Paquete grande."),
    item("Aceite bebé", 16000, "baby oil", "Frasco 100 ml."),
    item("Shampoo bebé", 19500, "baby shampoo", "Formula suave."),
    item("Tetero 8 oz", 22000, "baby bottle", "Libre de BPA."),
    item("Chupo ortodontico", 14500, "pacifier", "Silicona suave."),
    item("Talco bebé", 12500, "baby powder", "Aroma suave."),
...
const stationery = [
  ...
  category("Arte", [
    ...
    item("Lienzo pequeño", 22000, "canvas painting", "Bastidor pequeño."),
    item("Plastilina", 7200, "modeling clay", "Barra colores."),
    item("Escarcha", 4500, "glitter", "Frasco pequeño."),
  ]),
  ...
  category("Regalos", [
    item("Bolsa regalo pequeña", 2500, "gift bag", "Diseño surtido."),
    item("Bolsa regalo grande", 4500, "gift bag", "Diseño surtido."),
    item("Papel regalo", 2800, "wrapping paper", "Pliego decorativo."),
    item("Tarjeta felicitacion", 3500, "greeting card", "Mensaje especial."),
    item("Cinta decorativa", 4000, "ribbon", "Rollo pequeño."),
    item("Globo metalizado", 9500, "foil balloon", "Diseño celebracion."),
    ...
    item("Peluche pequeño", 28000, "plush toy", "Detalle pequeño."),
  ]),
];
...
const supermarket = [
  ...
  category("Lacteos", [
    ...
    item("Mantequilla", 7800, "butter", "Barra pequeña."),
    item("Kumis", 6500, "yogurt drink", "Botella."),
    item("Crema de leche", 5200, "cream carton", "Caja pequeña."),
...
const hardware = [
  category("Herramientas", [
    ...
    item("Nivel pequeño", 22000, "spirit level", "Nivel de burbuja."),
  ...
  category("Pintura", [
    ...
    item("Rodillo pequeño", 12000, "paint roller", "Unidad."),
...
const beauty = [
  ...
  category("Unas", [
    ...
    item("Lima uñas", 3500, "nail file", "Unidad."),
    item("Cortauñas", 6500, "nail clipper", "Metalico."),
...
const technology = [
  ...
  category("Audio", [
    ...
    item("Parlante pequeño", 65000, "small speaker", "Compacto."),
...
const petShop = [
  ...
  category("Higiene", [
    ...
    item("Cortauñas mascota", 16000, "pet nail clipper", "Unidad."),
  ...
  category("Accesorios", [
    ...
    item("Guacal pequeño", 98000, "pet carrier", "Transporte."),
    item("Ropa mascota", 35000, "dog clothes", "Talla pequeña."),
...
const fashionCatalog = [
  ...
  category("Hombre", [
    ...
    item("Jean slim", 119900, "men jeans", "Azul clásico."),
  ...
  category("Accesorios", [
    ...
    item("Aretes pequeños", 29900, "earrings fashion", "Dorados."),
...
const jewelryCatalog = [
  category("Aretes", [
    item("Aretes perla", 45000, "pearl earrings", "Diseño clásico."),
    ...
    item("Candonga pequeña", 42000, "small hoop earrings", "Liviana."),
  ...
  category("Collares", [
    ...
    item("Collar corazon", 62000, "heart necklace", "Dije pequeño."),
  ...
  category("Anillos", [
    ...
    item("Anillo sello", 78000, "signet ring", "Diseño moderno."),
...
const DEMO_BUSINESSES = [
  ...
  },
  {
    ...
    headline: "Útiles, oficina, arte e impresiones para resolver rápido",
    ...
    lng: -73.35721,
    zone: "Buenos Aires",
    address: "Barrio Buenos Aires, Ocaña",
  ...
  },
  {
    ...
    headline: "Herramientas, pintura, electricidad y plomería en un solo lugar",
    ...
    lng: -73.35654,
    zone: "Mercado",
    address: "Zona de mercado, Ocaña",
    placeName: "Ferretería El Tornillo",
  ...
  {
    uid: "demo-tech-norte",
    email: "donjhonnathan+klicor.tecnología@gmail.com",
    username: "tech-norte-demo",
    publicLinkId: "demo-tech-norte",
    businessName: "Tech Norte",
    businessCategory: "retail_sales",
    businessType: "technology",
    headline: "Celulares, audio, computación y tecnología para el hogar",
  ...
  },
  {
    ...
    headline: "Ropa, zapatos y accesorios para explorar como catálogo visual",
  ...
  },
  {
    ...
    headline: "Joyería, bisutería y detalles para regalar",
